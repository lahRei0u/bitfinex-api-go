...
``` bash
go get github.com/lahRei0u/bitfinex-api-go
```
...
import (
	"fmt"
	"github.com/lahRei0u/bitfinex-api-go/v1"
)
...
See [examples](https://github.com/lahRei0u/bitfinex-api-go/tree/master/examples) and [doc.go](https://github.com/lahRei0u/bitfinex-api-go/blob/master/doc.go) for more examples.
...
1. Fork it (https://github.com/lahRei0u/bitfinex-api-go/fork)
